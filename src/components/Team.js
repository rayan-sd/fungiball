...
const tab = [
    ...
    {name : "Jean Matias" ,poste : "Founder & CEO", img : jean, twitter: "https://twitter.com/JeanMAT39740767", Instagram: "https://www.instagram.com/joao_gmts/", Linkedin: "https://www.linkedin.com/in/jean-matias-41a337174/"},
    ...
    {name : "VMS" ,poste : "Web3 Consulting Agency", img : vms, twitter: "https://www.vmstudio.xyz/", Instagram: "https://www.vmstudio.xyz/", Linkedin: "https://www.linkedin.com/company/virtual-miracle-studio/"},
]
                ...
                <div className='container-team'>
                    ...
                    <div className='box-top-team'>
                        <div className='box-team'>
                            ...
                            <div className='social-box'>
                                ...
                                <a href="https://www.linkedin.com/in/jean-matias-41a337174/">LinkedIn</a>
                            </div>
                        </div>
                    </div>
                    <div className='box-top-team'>
                        <div className='box-team'>
                            ...
                            <div className='social-box'>
                                ...
                                <a href='https://twitter.com/ERogerVasselin'>Twitter</a>
                            </div>
                        </div>
                        <div className='box-team'>
                            <div className="box-img-team">
                    ...
                    <div className='box-top-team'>
                        ...
                        <div className='box-team'>
                            ...
                            <div className='social-box'>
                                <a href='https://www.linkedin.com/company/virtual-miracle-studio/'>LinkedIn</a>
                                ...
                                <SwiperSlide>
                                    <div className='box-team-mobile'>
                                        ...
                                        <div className='social-box-mobile'>
                                                {value.Linkedin && <a href={value.Linkedin}>LinkedIn</a>}
                                                {value.twitter && <a href={value.twitter}>Twitter</a>}
                                                {value.Instagram && (
                                                    <div>
