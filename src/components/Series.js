                        ...
                        <div className='info-card-l'>
                            ...
                            <div className='text-card'>
                                ...
                                <div className='box-button'>
                                    <a target='_blank' href='https://docdro.id/6pBPFPo'>LEARN MORE</a>
                                </div>                                   
                            </div>
                        </div>
                        ...
                        <div className='info-card-l'>
                            ...
                            <div className='text-card'>
                                ...
                                <div className='box-button p2'>
                                    <a target='_blank' href='https://discord.gg/YJJw7RP33K'>JOIN DISCORD</a>
                                </div>                                 
                            </div>
                        </div>
                        <div className='info-card-r'>
...
Then, Top players gets rewarded in ETH, NFT cards and others special prizes according to their performances.</p>
                                ...
                                <div className='box-button'>
                                    <a target='_blank' href='https://discord.gg/YJJw7RP33K'>GET STARTED</a>
                                </div>
                            </div>
                        </div>
                        <div className='info-card-r'>
